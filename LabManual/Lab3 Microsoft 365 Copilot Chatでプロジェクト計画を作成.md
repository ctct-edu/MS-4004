...
1. Microsoft 365のナビゲーションペインで「**新しいチャット**」を選択します。
2. 画面右上の「**作業（Work）**」トグルが有効になっていることを確認してください。これにより、組織のデータにアクセスできるようになります。
...
4. プロンプト入力後、「**+**」ボタンをクリックして、コンテンツの追加をクリックします。**クラウドファイルを添付**（青い雲のアイコン）をクリックします。
